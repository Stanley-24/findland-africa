        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-xl font-bold">FindLand Africa</span>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Your trusted partner in finding and selling properties across Africa. 
              We connect buyers, sellers, and renters with verified, quality properties.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/properties?type=buy" className="text-gray-400 hover:text-white transition-colors">
                  Properties for Sale
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © {currentYear} FindLand Africa. All rights reserved.
            </div>
