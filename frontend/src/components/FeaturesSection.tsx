      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="flex items-center justify-center w-16 h-16 bg-blue-100 rounded-lg text-blue-600 mb-4">
                {feature.icon}
              </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Quick property verification and transaction processing</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Real-time market data and property value insights</p>
            </div>
          </div>
        </div>
      </div>
